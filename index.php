        ...
        <div class="container">
            ...
            <div class="links">
                ...
                <div class="inner" style="padding:4px 10px;">
                    ...
                    <tbody>
                        ...
                        <tr style="display:flex;">
                            <td><img src="https://adilene.neocities.org/images/bullet2.gif" class="bullet" draggable="false"></td><td><a href="/pages/webring.html" target="frame">Webring</a></td>
                        </tr>
                        <tr style="display:flex;">
            ...
            <div class="chatbox">
                      ...
                      <div><article id="comment_<?php echo($comment['id']); ?>" class="hentry" style="background:var(--h);margin:10px 0px 0px;padding:10px;">	
                                <footer class="post-info">
                                    <abbr class="published">
                                        <?php echo( date('m.d.Y', strtotime($comment['date']), date("h:ia") ) ); ?>
                                    </abbr>
                ...
                <div id="respond" style="padding:10px;margin-bottom:-20px;text-align: center;">
                    ...
                    <input type="text" name="comment_author" id="comment_author" value="" tabindex="1" required="required" placeholder="Name" style="width:100%;">

                    <input name="comment" id="comment" rows="1" tabindex="2"  required="required" placeholder="Message" style="width:100%;margin:10px 0px;">
